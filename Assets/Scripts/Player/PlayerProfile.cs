...
public class PlayerProfile : ScriptableObject {
    ...
    [SerializeField]
    [Tooltip("Velocidad del salto doble")]
    ...
    // Efecto de sonido de la colisión con las manzanas
    [SerializeField] private AudioClip collisionSFX;
    public AudioClip CollisionSFX { get => collisionSFX; }

    // Efecto de sonido de lastimar al jugador por un enemigo
